## SYNC WITH lean-premise-server (TODO)
...
class Premise(BaseInfo):
    ...
    (`@[expose]`). Always False outside the module system. Used by the server's
    visibility filter; there is intentionally no `is_private` field since private
    declarations are never extracted."""
